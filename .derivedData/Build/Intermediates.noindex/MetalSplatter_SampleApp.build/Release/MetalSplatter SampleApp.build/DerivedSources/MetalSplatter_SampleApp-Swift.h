...
#ifndef METALSPLATTER_SAMPLEAPP_SWIFT_H
#define METALSPLATTER_SAMPLEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MetalSplatter_SampleApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23MetalSplatter_SampleApp20CameraControlMTKView")
@interface CameraControlMTKView : MTKView
...
SWIFT_CLASS("_TtC23MetalSplatter_SampleApp21MetalKitSceneRenderer")
@interface MetalKitSceneRenderer : NSObject <MTKViewDelegate>
